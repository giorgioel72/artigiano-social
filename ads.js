...
// ⭐ FUNZIONE MODIFICATA - BYPASS CONTROLLO ADMIN
async function checkAdminAccess() {
    ...
    // ⭐ PER TEST: NON CONTROLLIAMO IL RUOLO, ACCETTIAMO TUTTI
    console.log('✅ Accesso admin consentito (modalità test)');
    return true;
}
    ...
    if (navLinks) {
        if (token && user) {
            ...
            navLinks.innerHTML = `
                ...
                <a href="../../pages/auth/login.html">Accedi</a>
            `;
        }
    }
}
...
document.addEventListener('DOMContentLoaded', async () => {
    // Bypassa il controllo admin per test
    console.log('🚀 Avvio pagina admin (modalità test)');
